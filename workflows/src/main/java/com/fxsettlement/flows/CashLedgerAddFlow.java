...
public class CashLedgerAddFlow {
    @InitiatingFlow
    @StartableByRPC
    public static class CashLedgerAddFlowInitiator extends FlowLogic<SignedTransaction> {
        private final Party responder;
        private final String accountId;
        private final String currency;
        private final float amount;

        public CashLedgerAddFlowInitiator(Party responder, String accountId, String currency, float amount) {
...
@InitiatedBy(CashLedgerAddFlowInitiator.class)
public static class CashLedgerAddFlowResponder extends FlowLogic<Void>{
    //private variable
    private FlowSession counterpartySession;

    //Constructor
    public CashLedgerAddFlowResponder(FlowSession counterpartySession) {
