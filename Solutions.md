...
import com.bootcamp.contracts.FXTradeContract;
...
import com.bootcamp.states.FXTradeState;
...
public class TokenContract implements Contract {
    public static String ID = "com.bootcamp.contracts.FXTradeContract";
...
public static class TokenIssueFlowInitiator extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        TokenState FXTradeState = new TokenState(issuer, owner, amount);
        ...
        transactionBuilder.addOutputState(FXTradeState, TokenContract.ID);
